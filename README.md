...
3. Create a dedicated page for your workbench on the FreeCAD wiki (don't forget to add `[[Category:Addons]]` in it + add it to https://freecadweb.org/wiki/External_workbenches
